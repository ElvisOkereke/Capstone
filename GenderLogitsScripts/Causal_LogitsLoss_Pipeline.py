...
class WinoBiasDebiasLoss(nn.Module): #for non-sequential transformers
...
def main():
    ...
    try:
        ...
        debiasing_loss = WinoBiasDebiasLoss(
        ...
        fine_tuned_model = AutoModelForCausalLM.from_pretrained("./GLD_fine_tuned_model")
